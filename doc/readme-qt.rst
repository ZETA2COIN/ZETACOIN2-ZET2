ZETA2COIN-qt: Qt5 GUI for ZETA2COIN
===============================
...
A warning for people using the *static binary* version of ZETA2COIN on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of ZETA2COIN is linked against libdb 5.0 (see also `this Debian issue`_).
